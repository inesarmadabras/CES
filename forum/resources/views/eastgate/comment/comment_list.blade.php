<div class="comment-list">
	<div class="row">
		<div class="col-xs-12">	
			<h2>{!! $total_comments !!} Comentário(s) </h2>
				...
				<div class="col-xs-offset-{!! $offset_length !!} col-xs-{!! $comment_length !!}">
					...
					<div class="col-md-11">
						...
						<p style="color: darkgrey; font-size: 12px;">
							@if(Auth::check())
								<i class="glyphicon glyphicon-pencil"></i> <a href="javascript:void(0)" class="reply comment{!! $each_comment->id !!}" title="Reply to above comment">Responder</a>
							@endif
						</p>
	...
	<div class="row">
		<div class="col-xs-12">
			Show <input type="text" name="comments_per_page" class="comments_per_page" value="{!! $per_page !!}" size="2" title="Number of comments per page"> comentários por página
		</div>
	</div>--}}
</div>
